...
#Run Image
docker run --rm -it -e "ELASTICSEARCH_HOSTS=http://jmeter-elastic:9200" -v ${PWD}/input:/input/ logstash/jmeter/elasticsearch
...
| `DROP_LINE_MESSAGE`                  | Remove field message.                                                                                                                                                 | true      |
| `CLEANUP_FIELDS`                     | Remove fields : host, path.                                                                                                                                           | true      |
